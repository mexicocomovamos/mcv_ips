...
# Nota: Por como está estructurado el código, el dato Nacional se tiene que 
# capturar de manera manual en el Drive. 
...
p_load(readxl, tidyverse, dplyr, googledrive, mxmaps, 
       googlesheets4, lubridate, janitor, beepr, sf)
...
googlesheets4::range_write(ss = v_id, data = df_ips,
                           sheet = "01_mapa")
