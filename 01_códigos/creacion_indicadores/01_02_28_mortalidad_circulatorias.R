...
# df_prev_mortalidad_circulatorias <- df_final 
# 
# save(df_prev_mortalidad_circulatorias, 
#      file = paste_out("df_prev_mortalidad_circulatorias.RData"))

# Base con año de ocurrencia 
df_post_mortalidad_circulatorias <- df_final 

save(df_post_mortalidad_circulatorias, 
     file = paste_out("df_post_mortalidad_circulatorias.RData"))
